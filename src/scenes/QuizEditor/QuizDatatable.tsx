                    ...
                    <TableRow>
                        <TableCell align="left">
                            ...
                            >
                                ...
                                <IconButton size="small" disabled style={{ marginLeft: '1em' }}>
                                    <EditIcon />
                                </IconButton>
                                <IconButton onClick={() => setOpen(!isOpen)} style={{ marginLeft: '1em' }}>
                                ...
                                <GridLayout
                                    elements={[
                                            ...
                                            element: (
                                                ...
                                                >
                                                    <TextField
                                                        ...
                                                        onChange={(event) => {
                                                            setDescription(
                                                                newFormItem(event.currentTarget.value, true)
                                                            );
                                                        }}
                                                        onBlur={(event) => {
                                        ...
                                        },
                                        {
                                            id: 'data',
                                            element: (
                                                <QuizSection section_id={props.data.section_id} questions={questions} />
                                            ),
                                            xs: 12,
                                        },
                                    ]}
    ...
    return (
        <Box mb={10}>
            {props?.data?.quiz_sections?.map((section, sectionIndex) => (
                <Paper key={section.section_id} variant={'elevation'} elevation={3} style={{ flexGrow: 1 }}>
