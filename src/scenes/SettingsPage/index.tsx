        ...
        <Fade in={true} timeout={drawerTransitionTime}>
            <Paper variant={'elevation'} elevation={5} style={{textAlign: 'center', padding: '1em', margin: '1em', backgroundColor: theme.palette.grey[200]}} >
                <Typography variant='h4' paragraph style={{display: 'inline-flex'}}>
                    <SettingsIcon fontSize={'large'} style={{marginRight: '0.5em'}}/> 
                    Settings Page
                </Typography>
                <Typography variant='h6' paragraph>Here, you can edit your account preferences</Typography>
                    ...
                    elements={[
                        {
                            ...
                            element: (
                                <Stack spacing={2} direction="row" sx={{ mb: 1 }} alignItems="center" style={{width: '100%'}}>
                                    <VolumeDown />
                                    <Slider value={volume} onChange={(event, newValue) => setVolume(newValue as number)}/>
                                    <VolumeUp />
                                </Stack>
                            ),
                            xs: 6
